...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="""Compress particle structs in some path in parallel. Path is usually $vpic_data/particle. Another directory $vpic_data/particle.compressed will be created, with an identical hierarchy, containing compressed versions of the pearticle files.""")
    parser.add_argument('dir_path', metavar='dir', type=str, help='path to a directory containing eparticle files')
